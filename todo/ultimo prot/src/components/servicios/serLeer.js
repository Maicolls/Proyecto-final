    ...
    <div className="d-flex h-75 bg-dark justify-content-center align-items-center">
      <div className="w-50 bg-white rounded p-3">
        <div className="p-2">
          ...
          <p className="h4 fs-3">Nombre: {servicios.nombre_s}</p>
          <p className="h4 fs-3">Descripción: {servicios.descripcion_s}</p>
          <p className="h4 fs-3">Tipo: {servicios.tipo_s}</p>
          <p className="h4 fs-3">Categoria: {servicios.categoria_s}</p>
        </div>
